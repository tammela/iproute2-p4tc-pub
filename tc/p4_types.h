...
enum {
	P4TC_T_TYPE_BIT = BIT(0),
	P4TC_T_TYPE_INT = BIT(1),
	P4TC_T_TYPE_BIGENDIAN = BIT(2),
	P4TC_T_TYPE_UNSIGNED = BIT(3),
	P4TC_T_TYPE_SIGNED = BIT(4),
	P4TC_T_TYPE_HAS_MASK = BIT(5),
};
...
static inline bool p4type_bigendian(struct p4_type_s *type)
{
	return type->flags & P4TC_T_TYPE_BIGENDIAN;
}
