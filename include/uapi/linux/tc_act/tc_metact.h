...
enum {
	...
	METACT_OP_PRINT,
	METACT_OP_TBLAPP,
	METACT_OP_SNDPORTEGR,
	METACT_OP_MIRPORTEGR,
	__METACT_OP_MAX
};
...
#define METACT_RESULTS_HIT 1
#define METACT_RESULTS_MISS 2
...
/* operand flags */
#define DATA_IS_IMMEDIATE ((__u8)BIT(0)) /* data is held as immediate value */
#define DATA_IS_RAW ((__u8)BIT(1))	 /* bitXX datatype, not intepreted by kernel */
#define DATA_IS_SLICE ((__u8)BIT(2))	 /* bitslice in a container, not intepreted
					  * by kernel
					  */
/* TCA_METACT_PARMS */
struct tc_metact {
