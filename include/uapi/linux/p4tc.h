...
#define P4TC_CONTROL_PERMISSIONS_U_BIT 7
#define P4TC_CONTROL_PERMISSIONS_D_BIT 6
#define P4TC_CONTROL_PERMISSIONS_X_BIT 5
#define P4TC_DATA_PERMISSIONS_C_BIT 4
#define P4TC_DATA_PERMISSIONS_R_BIT 3
#define P4TC_DATA_PERMISSIONS_U_BIT 2
#define P4TC_DATA_PERMISSIONS_D_BIT 1
#define P4TC_DATA_PERMISSIONS_X_BIT 0

#define P4TC_CONTROL_PERMISSIONS_C (1 << P4TC_CONTROL_PERMISSIONS_C_BIT)
#define P4TC_CONTROL_PERMISSIONS_R (1 << P4TC_CONTROL_PERMISSIONS_R_BIT)
#define P4TC_CONTROL_PERMISSIONS_U (1 << P4TC_CONTROL_PERMISSIONS_U_BIT)
#define P4TC_CONTROL_PERMISSIONS_D (1 << P4TC_CONTROL_PERMISSIONS_D_BIT)
#define P4TC_CONTROL_PERMISSIONS_X (1 << P4TC_CONTROL_PERMISSIONS_X_BIT)
#define P4TC_DATA_PERMISSIONS_C (1 << P4TC_DATA_PERMISSIONS_C_BIT)
#define P4TC_DATA_PERMISSIONS_R (1 << P4TC_DATA_PERMISSIONS_R_BIT)
#define P4TC_DATA_PERMISSIONS_U (1 << P4TC_DATA_PERMISSIONS_U_BIT)
#define P4TC_DATA_PERMISSIONS_D (1 << P4TC_DATA_PERMISSIONS_D_BIT)
#define P4TC_DATA_PERMISSIONS_X (1 << P4TC_DATA_PERMISSIONS_X_BIT)
