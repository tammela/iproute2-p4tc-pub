...
enum {
	...
	P4TC_FILTER_OPND_ENTRY_ACT, /* nested action - P4TC_FITLER_OPND_ACT_XXX */
...
enum {
	...
	P4TC_FILTER_OPND_ENTRY, /* nested entry operands - P4TC_FILTER_OPND_ENTRY_XXX */
...
enum {
	...
	P4TC_FILTER_OP_KIND, /* P4TC_FILTER_OP_KIND_REL || P4TC_FILTER_OP_KIND_LOGICAL */
	...
	P4TC_FILTER_OP_NODE2, /* nested - P4TC_FILTER_OP_NODE_XXX - Present only for
